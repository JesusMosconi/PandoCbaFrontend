  ...
  return (
    <section className="p-6 sm:p-10">
      <div className="flex items-end justify-between border-b-2 border-black pb-5">
        <div><p className="font-manrope text-[10px] font-bold uppercase tracking-[0.28em] text-gray-500">Tu selección</p><h1 className="mt-2 font-epilogue text-4xl font-bold uppercase tracking-[-0.04em]">Carrito</h1></div>
